                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form class="w-full">
                        <div class="flex flex-wrap mb-6 -mx-3">
                            <div class="w-full px-4 mb-4 md:mb-0">
                                ...
                                <input
                                    ...
                                    id="grid-first-name" type="text" placeholder="Post Title">
                        ...
                        <div class="w-full px-3 mb-3 ">
                            ...
                            <textarea class="block w-full px-4 py-3 mb-3 rounded" name="" placeholder="Enter Post Description" id="" cols="30" rows="10"></textarea>
                        </div>
                        <button
